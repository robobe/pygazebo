...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto2',
  options=None,
  serialized_pb=_b('\n\x10rest_login.proto\x12\x0bgazebo.msgs\"<\n\tRestLogin\x12\x0b\n\x03url\x18\x01 \x02(\t\x12\x10\n\x08username\x18\x02 \x01(\t\x12\x10\n\x08password\x18\x03 \x01(\t')
)
...
_RESTLOGIN = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='url', full_name='gazebo.msgs.RestLogin.url', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='username', full_name='gazebo.msgs.RestLogin.username', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='password', full_name='gazebo.msgs.RestLogin.password', index=2,
