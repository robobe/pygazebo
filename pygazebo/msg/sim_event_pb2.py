...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto2',
  options=None,
  serialized_pb=_b('\n\x0fsim_event.proto\x12\x0bgazebo.msgs\x1a\x11world_stats.proto\"l\n\x08SimEvent\x12\x0c\n\x04type\x18\x01 \x02(\t\x12\x0c\n\x04name\x18\x02 \x02(\t\x12\x36\n\x10world_statistics\x18\x03 \x02(\x0b\x32\x1c.gazebo.msgs.WorldStatistics\x12\x0c\n\x04\x64\x61ta\x18\x04 \x01(\t')
  ,
...
_SIMEVENT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='gazebo.msgs.SimEvent.type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='gazebo.msgs.SimEvent.name', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='world_statistics', full_name='gazebo.msgs.SimEvent.world_statistics', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='gazebo.msgs.SimEvent.data', index=3,
